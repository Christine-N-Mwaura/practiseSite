(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[14],{"+VrF":function(e,t,r){"use strict"
var n=r("284h")
var a=r("TqRt")
...
f.variant="Solid"
f.propTypes=(0,o.default)({},p.default.propTypes)},EefQ:function(e,t,r){"use strict"
var n=r("284h")
var a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:true})
t.default=void 0
...
f.variant="Solid"
f.propTypes=(0,o.default)({},p.default.propTypes)},PY7K:function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:true})
t.default=n
function n(e){var t=e.colors,r=e.borders,n=e.spacing,a=e.typography,o=e.shadows
return{background:t.backgroundLightest,color:t.textDarkest,marginTop:n.small,borderRadius:r.radiusMedium,borderWidth:r.widthMedium,borderStyle:r.style,contentPadding:"".concat(n.small," ").concat(n.medium),contentFontSize:a.fontSizeMedium,contentFontFamily:a.fontFamily,contentFontWeight:a.fontWeightNormal,contentLineHeight:a.lineHeightCondensed,closeButtonMarginTop:n.xSmall,closeButtonMarginRight:n.xxSmall,iconColor:t.textLightest,iconBackground:t.backgroundLightest,successBorderColor:t.borderSuccess,successIconBackground:t.backgroundSuccess,infoBorderColor:t.borderInfo,infoIconBackground:t.backgroundInfo,warningBorderColor:t.borderWarning,warningIconBackground:t.backgroundWarning,dangerBorderColor:t.borderDanger,dangerIconBackground:t.backgroundDanger,boxShadow:o.depth2}}n.canvas=function(e){return{color:e["ic-brand-font-color-dark"]}}},"SoT/":function(e,t,r){"use strict"
var n=r("284h")
var a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:true})
t.default=void 0
...
f.variant="Solid"
f.propTypes=(0,o.default)({},p.default.propTypes)},TEfk:function(e,t,r){var n=r("q1tI")
function a(){var e=""
...
var o
for(var i=arguments.length,c=new Array(i>3?i-3:0),s=3;s<i;s++)c[s-3]=arguments[s];(o=console)[e].apply(o,["Warning: ".concat(r)].concat(c,[n]))}}t.error=function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
...
return(e=console).log.apply(e,arguments)}},TZKM:function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:true})
t.default=o
var a=n(r("MVZn"))
function o(e){var t=e.typography,r=e.colors,n=e.spacing
return(0,a.default)({},t,{primaryInverseColor:r.textLightest,primaryColor:r.textDarkest,secondaryColor:r.textDark,secondaryInverseColor:r.textLight,warningColor:r.textWarning,brandColor:r.textBrand,errorColor:r.textDanger,successColor:r.textSuccess,paragraphMargin:"".concat(n.medium," 0")})}o.canvas=function(e){return{primaryColor:e["ic-brand-font-color-dark"],brandColor:e["ic-brand-primary"]}}},YSFS:function(e,t,r){"use strict"
var n=r("284h")
var a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:true})
t.default=void 0
...
var r=(0,_.default)(t,this.props)
...
var h=v
t.default=h},YTJb:function(e,t,r){"use strict"
var n=r("TqRt")
var a=r("284h")
Object.defineProperty(t,"__esModule",{value:true})
t.default=void 0
...
t.default=L},dqQ7:function(e,t,r){"use strict"
var n=r("An8g")
var a=r("1OyB")
var o=r("vuIU")
var i=r("md7G")
...
function t(e){var r
Object(a["a"])(this,t)
r=Object(i["a"])(this,Object(c["a"])(t).call(this,e))
r.showDetails=function(){r.setState({showDetails:true})
clearTimeout(r.timerId)
r.timerId=setTimeout(function(){return r.closeAlert()},r.props.timeout)}
r.closeAlert=function(){r.setState({isOpen:false},function(){setTimeout(function(){clearTimeout(r.timerId)
r.props.onClose()},500)})}
r.state={showDetails:false,isOpen:true}
r.timerId=0
return r}Object(o["a"])(t,[{key:"getLiveRegion",value:function(){var e=document.getElementById(C)
...
r=e.message}}catch(r){t=e.message}return{a:t,b:r}}},{key:"renderDetailMessage",value:function(){var e=this.findDetailMessage(),t=e.a,r=e.b
return Object(n["a"])(E.a,{as:"p",fontStyle:"italic"},void 0,Object(n["a"])(E.a,{},void 0,t),r?S:null,r?Object(n["a"])(E.a,{},void 0,r):null)}},{key:"render",value:function(){var e=null
this.props.error&&(e=this.state.showDetails?this.renderDetailMessage():Object(n["a"])("span",{},void 0,Object(n["a"])(L.a,{},void 0,Object(n["a"])(g.a,{variant:"link",onClick:this.showDetails},void 0,v.t("Details"))),Object(n["a"])(w.a,{},void 0,this.renderDetailMessage())))
return Object(n["a"])(G.a,{transitionOnMount:true,in:this.state.isOpen,type:"fade"},void 0,Object(n["a"])(b.a,{variant:this.props.variant,closeButtonLabel:v.t("Close"),onDismiss:this.closeAlert,margin:"small auto",timeout:this.props.timeout,liveRegion:this.getLiveRegion,transition:"fade",screenReaderOnly:this.props.screenReaderOnly},void 0,Object(n["a"])("div",{},void 0,Object(n["a"])("p",{style:{margin:"0 -5px"}},void 0,this.props.message),e)))}}])
t.displayName="FlashAlert"
return t}(d.a.Component)
I.defaultProps={error:null,variant:"info",timeout:q,screenReaderOnly:false}
function O(e){var t=e.message,r=e.err,a=e.type,o=void 0===a?r?"error":"info":a,i=e.srOnly,c=void 0!==i&&i
...
document.body.appendChild(e)}return e}function d(e){p.a.render(Object(n["a"])(I,{message:t,timeout:isNaN(ENV.flashAlertTimeout)?q:ENV.flashAlertTimeout,error:r,variant:o,onClose:s.bind(null,e),screenReaderOnly:c}),e)}var u=document.createElement("div")
u.setAttribute("style","max-width:50em;margin:1rem auto;")
u.setAttribute("class","flashalert-message")
l().appendChild(u)
d(u)}function D(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:v.t("An error occurred making a network request")
return function(t){return O({message:e,err:t,type:"error"})}}function M(e){return function(){return O({message:e,type:"success"})}}},h8gV:function(e,t,r){"use strict"
var n=r("TqRt")
var a=r("284h")
Object.defineProperty(t,"__esModule",{value:true})
t.default=void 0
...
var D=(x=(0,w.default)("3.0.0",{dismissable:true,onClose:"onDismiss",transitionType:"transition",isOpen:"open"}),C=(0,L.default)(G.default,O),x(q=C(q=(I=S=function(e){(0,l.default)(t,e)
function t(e){var r;(0,o.default)(this,t)
r=(0,c.default)(this,(0,s.default)(t).call(this,e))
r._timeouts=[]
...
t.displayName="Alert"
return t}(d.Component),S.propTypes={children:p.default.node,variant:p.default.oneOf(["info","success","warning","error"]),margin:H.default.spacing,liveRegion:p.default.func,liveRegionPoliteness:p.default.oneOf(["polite","assertive"]),screenReaderOnly:p.default.bool,timeout:p.default.number,closeButtonLabel:p.default.string,onDismiss:p.default.func,transition:p.default.oneOf(["none","fade"]),open:p.default.bool},S.defaultProps={variant:"info",margin:"x-small 0",timeout:0,transition:"fade",open:true,screenReaderOnly:false,liveRegionPoliteness:"assertive",onDismiss:void 0,liveRegion:void 0,closeButtonLabel:void 0,children:null},I))||q)||q)
t.default=D},vRP1:function(e,t,r){"use strict"
var n=r("284h")
var a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:true})
t.default=void 0
...
//# sourceMappingURL=14-c-4fe10a3dd4.js.map