...
e.attr("tabindex",-1)}}])
return e}()},mykf:function(e,t,i){"use strict"
var n=function(){var e=ENV.LTI_LAUNCH_FRAME_ALLOWANCES||[]
return e.join("; ")}
t["a"]=n},rkWX:function(e,t,i){"use strict"
i.r(t)
var n=i("ouhR")
var r=i.n(n)
var o=i("yiTI")
...
i("YGE8")
i("p6Wi")
var j=function(){function e(){Object(d["a"])(this,e)}Object(u["a"])(e,[{key:"fetchYouTubeTitle",value:function(e,t){var i=ENV.JWT
...
return new z(e)}function P(e,t){var i=e.replace(/(auto_open|inline_disabled)/g,"")
t.find(".auto_show_inline_content").attr("checked")&&(i+=" auto_open")
t.find(".disable_inline_content").attr("checked")&&(i+=" inline_disabled")
return i}function O(e,t,i,n){var o=e.find("#instructure_link_prompt_form")
o.off("submit")
...
r.a.getUserServices("BookmarkService",function(e){var t=n.data("editor")
...
r.a.findLinkForService(r()(this).data("service").service,function(e){r()("#instructure_link_prompt").dialog("close")
...
true==t&&0!=S.counter?S.counter=(S.counter+1)%5:r()(e.getBody()).find("a").each(function(){var e=new j
var t=r()(this)
...
t.text()===t.attr("href")&&i<1&&e.titleYouTubeText(t)}})}function I(e){if(R.get(e)||void 0===e.on)return
...
R.set(e,true)}var V={buttonToImg:B,prepEditorForDialog:L,buildLinkClasses:P,bindLinkSubmit:O,renderDialog:N,updateLinks:S,initEditor:I}
i("q1tI")
var D=i("i8i4")
var M=i.n(D)
var q={more_external_tools:Object(y["a"])(w.t("more_external_tools","More External Tools"))}
var G={init:function(e,t,n){V.initEditor(e)
...
Promise.all([i.e(0),i.e(1),i.e(2),i.e(3),i.e(4),i.e(6),i.e(10),i.e(12),i.e(539)]).then(i.bind(null,"/wcz")).then(function(t){var i=t.default
var n=document.createElement("div")
document.body.appendChild(n)
M.a.render(Object(b["a"])(i,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(T["a"])(),resourceSelectionUrl:r()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),n,function(){o=this})})
var a=[]
var s=[]
var l=function(t){var i=n.editorButtons[t]
if(ENV.use_rce_enhancements)s.push(x.buttonConfig(i,e))
else if(n.editorButtons.length>n.maxVisibleEditorButtons&&t>=n.maxVisibleEditorButtons-1)a.push(i)
...
ENV.use_rce_enhancements?e.ui.registry.addButton("instructure_external_button_clump",{title:q.more_external_tools,image:"/images/downtick.png",onAction:d}):e.addButton("instructure_external_button_clump",{title:q.more_external_tools,image:"/images/downtick.png",onkeyup:function(e){if(32===e.keyCode||13===e.keyCode){e.stopPropagation()
...
Promise.all([i.e(5),i.e(541)]).then(i.bind(null,"F+Bh")).then(function(t){var i=t.default
var r=new i(n.ed)
e.equationCB(r)})})
document.addEventListener("tinyRCE/initLinks",function(t){var i=t.detail
V.renderDialog(i.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",function(t){Promise.all([i.e(0),i.e(1),i.e(2),i.e(3),i.e(4),i.e(5),i.e(10),i.e(14),i.e(15),i.e(90),i.e(94),i.e(552)]).then(i.bind(null,"Dwgn")).then(function(i){var n=i.default
var r=new n(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(r)})})
document.addEventListener("tinyRCE/initEquella",function(t){i.e(562).then(i.bind(null,"gg/z")).then(function(i){var n=i.default
n(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",function(t){H.init(t.detail.ed,t.detail.url,_["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",function(t){Promise.all([i.e(15),i.e(38),i.e(563)]).then(i.bind(null,"xR7n")).then(function(i){var n=i.default
n.insertEditor(t.detail.ed)
e.recordCB()})})}var U={call:function(e){if("exists?"===e)return true
for(var t=arguments.length,i=new Array(t>1?t-1:0),n=1;n<t;n++)i[n-1]=arguments[n]
return this[e].apply(this,i)},focus:function(){if(void 0!==tinymce){var e=tinymce.get(this._textareaEl.id)
e&&e.focus(true)}}}
var K={show:function(){$("#editor_tabs").show()},hide:function(){$("#editor_tabs").hide()}}
var Y={wrapEditor:function(e){var t=a.a.extend({},U,e)
return a.a.extend(e,t)},wrapSidebar:function(e){var t=a.a.extend({},K,e)
return a.a.extend(e,t)}}
var J=Y
var Z=i("Cf7h")
function Q(){if(!ENV.context_asset_string)return null
var e=Object(Z["a"])(ENV.context_asset_string)
return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,contextId:e[1],contextType:e[0],filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:l(ENV.JWT),themeUrl:ENV.active_brand_config_json_url}}var X
var ee={preload:function(e){this.loadRCE(e)},loadOnTarget:function(e,t,i){var n=this.getTargetTextarea(e)
var r=this.getRenderingTarget(n,t.getRenderingTarget)
var o=this.createRCEProps(n,t)
this.loadRCE(function(e){e.renderIntoDiv(r,o,function(e){e.mceInstance().on("init",function(){return i(n,J.wrapEditor(e))})})})},loadSidebarOnTarget:function(e,t){if(ENV.RICH_CONTENT_SKIP_SIDEBAR)return
var i=Q()
this.loadRCE(function(n){n.renderSidebarIntoDiv(e,i,function(e){t(J.wrapSidebar(e))})})},loadingCallbacks:[],RCE:null,loadRCE:function(){var e=this
var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:function(){}
X||(X=(window.ENV.use_rce_enhancements?Promise.all([i.e(0),i.e(1),i.e(2),i.e(3),i.e(4),i.e(6),i.e(7),i.e(8),i.e(9),i.e(11),i.e(17),i.e(19),i.e(21),i.e(22),i.e(28),i.e(36),i.e(40),i.e(47),i.e(56),i.e(61),i.e(59),i.e(91),i.e(99),i.e(201),i.e(243)]).then(i.bind(null,"Idzl")):Promise.all([i.e(0),i.e(1),i.e(2),i.e(3),i.e(4),i.e(6),i.e(7),i.e(8),i.e(9),i.e(11),i.e(17),i.e(19),i.e(21),i.e(22),i.e(26),i.e(27),i.e(28),i.e(36),i.e(40),i.e(47),i.e(56),i.e(61),i.e(59),i.e(91),i.e(244)]).then(i.bind(null,"66gZ"))).then(function(t){e.RCE=t
W()
return t}))
return X.then(function(){e.loadingCallbacks.forEach(function(t){return t(e.RCE)})
e.loadingCallbacks=[]
...
return{defaultContent:e.value||t.defaultContent,editorOptions:g.bind(null,i,e.id,t,null),language:ENV.LOCALE,mirroredAttrs:this._attrsToMirror(e),onFocus:t.onFocus,textareaClassName:e.className,textareaId:e.id,trayProps:Q()}}}
t["a"]=ee}}])

//# sourceMappingURL=23-c-91d98461dd.js.map