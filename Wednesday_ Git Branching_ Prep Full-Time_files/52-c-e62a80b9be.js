(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[52],{"13m+":function(e,t,o){"use strict"
var c=o("17x9")
var a=o.n(c)
var l=o("v0Tn")
var n=a.a.shape,i=a.a.string,r=a.a.arrayOf,_=a.a.oneOf,s=a.a.bool,u=a.a.instanceOf
var k={}
k.migrationState=_(l["a"].statesList)
k.term=n({id:i.isRequired,name:i.isRequired})
k.termList=r(k.term)
k.account=n({id:i.isRequired,name:i.isRequired})
k.accountList=r(k.account)
k.course=n({id:i.isRequired,name:i.isRequired,course_code:i.isRequired,term:k.term.isRequired,teachers:r(n({display_name:i.isRequired})).isRequired,sis_course_id:i})
k.courseList=r(k.course)
k.courseInfo=n({id:i.isRequired,name:i.isRequired,enrollment_term_id:i.isRequired,sis_course_id:i})
...
k.migrationException=n({course_id:i.isRequired,conflicting_changes:k.lockableAttributeList})
k.migrationExceptionList=r(k.migrationException)
k.migrationChange=n({asset_id:i.isRequired,asset_type:_(["assignment","quiz","discussion_topic","wiki_page","attachment","context_module","learning_outcome","learning_outcome_group","announcement","rubric","syllabus"]).isRequired,asset_name:i.isRequired,change_type:_(["created","updated","deleted"]).isRequired,htnl_url:i,exceptions:k.migrationExceptionList})
k.migrationChangeList=r(k.migrationChange)
k.migration=n({id:i.isRequired,workflow_state:k.migrationState.isRequired,comment:i,created_at:i.isRequired,exports_started_at:i,imports_queued_at:i,imports_completed_at:i,changes:k.migrationChangeList})
k.migrationList=r(k.migration)
k.unsyncedChange=n({asset_id:i.isRequired,asset_type:i.isRequired,asset_name:i.isRequired,change_type:i.isRequired,html_url:i.isRequired,locked:s.isRequired})
k.unsyncedChanges=r(k.unsyncedChange)
k.notification=n({id:i.isRequired,message:i.isRequired,err:u(Error)})
k.notificationList=r(k.notification)
k.itemLocks=n({content:s,points:s,due_dates:s,availability_dates:s})
k.itemLocksByObject=n({assignment:k.itemLocks,discussion_topic:k.itemLocks,wiki_page:k.itemLocks,quiz:k.itemLocks,attachment:k.itemLocks})},OAMf:function(e,t,o){"use strict"
var c=o("pQTu")
var a=o("m0r6")
Object(a["a"])({ar:{no_attributes_locked_611c5cc:"لم يتم تأمين أي سمات"},cy:{no_attributes_locked_611c5cc:"dim priodoleddau wedi’u cloi"},da:{no_attributes_locked_611c5cc:"ingen attributter låst"},"da-x-k12":{no_attributes_locked_611c5cc:"ingen attributter låst"},de:{no_attributes_locked_611c5cc:"Keine Attribute gesperrt"},"en-AU":{no_attributes_locked_611c5cc:"no attributes locked"},"en-AU-x-unimelb":{no_attributes_locked_611c5cc:"no attributes locked"},"en-CA":{no_attributes_locked_611c5cc:"no attributes locked"},"en-GB":{no_attributes_locked_611c5cc:"no attributes locked"},"en-GB-x-lbs":{no_attributes_locked_611c5cc:"no attributes locked"},"en-GB-x-ukhe":{no_attributes_locked_611c5cc:"no attributes locked"},es:{no_attributes_locked_611c5cc:"no se han bloqueado atributos"},fa:{no_attributes_locked_611c5cc:"هیچ ویژگی قفل نشده"},fr:{no_attributes_locked_611c5cc:"aucun attribut verrouillé"},"fr-CA":{no_attributes_locked_611c5cc:"aucun attribut verrouillé"},ht:{no_attributes_locked_611c5cc:"Pa gen okenn atribi ki bloke"},is:{no_attributes_locked_611c5cc:"engir læstir eiginleikar"},it:{no_attributes_locked_611c5cc:"nessun attributo bloccato"},ja:{no_attributes_locked_611c5cc:"属性がロックされていません"},mi:{no_attributes_locked_611c5cc:"Kāore ngā huanga i te raka"},nb:{no_attributes_locked_611c5cc:"ingen låste attributter"},"nb-x-k12":{no_attributes_locked_611c5cc:"ingen låste attributter"},nl:{no_attributes_locked_611c5cc:"geen vergrendelde eigenschappen"},nn:{no_attributes_locked_611c5cc:"ingen attributt er låste"},pl:{no_attributes_locked_611c5cc:"brak zablokowanych atrybutów"},pt:{no_attributes_locked_611c5cc:"Sem atributos bloqueados"},"pt-BR":{no_attributes_locked_611c5cc:"nenhum atributo bloqueado"},ru:{no_attributes_locked_611c5cc:"нет заблокированных атрибутов"},sl:{no_attributes_locked_611c5cc:"ni zaklenjenih atributov"},sv:{no_attributes_locked_611c5cc:"Inga attribut låsta"},"sv-x-k12":{no_attributes_locked_611c5cc:"Inga attribut låsta"},uk:{no_attributes_locked_611c5cc:"немає заблокованих атрибутів"},"zh-Hans":{no_attributes_locked_611c5cc:"未锁定任何属性"},"zh-Hant":{no_attributes_locked_611c5cc:"沒有鎖定屬性"}})
o("jQeR")
o("0sPK")
var l=c["default"].scoped("blueprint_LockItemFormat")
var n=o("3sT6")
o.d(t,"a",function(){return r})
function i(e){var t=e.map(function(e){return n["e"][e]})
...
return i(t)}},lubD:function(e,t,o){"use strict"
var c=o("x1Tw")
var a=o("pREb")
var l=o("v0Tn")
var n={_depaginate:function(e){var t=this
...
var n=o-1
if(e.headers.link&&n>0){var i=Object(a["a"])(e)
if(i.next)return t._depaginate(i.next,n,c)}e.data=c
...
var o=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},c=o.search,a=void 0===c?"":c,l=o.term,n=void 0===l?"":l,i=o.subAccount,r=void 0===i?"":i
var _=this._queryString([{per_page:"100"},{blueprint:"false"},{blueprint_associated:"false"},{"include[]":"term"},{"include[]":"teachers"},{search_term:a},{enrollment_term_id:n}])
...
return c["default"].get("/api/v1/courses/".concat(t.id,"/blueprint_templates/default/migrations"))},beginMigration:function(e){var t=e.masterCourse,o=e.willSendNotification,a=e.willIncludeCustomNotificationMessage,l=e.notificationMessage,n=e.willIncludeCourseSettings
var i={send_notification:o}
n&&(i.copy_settings=true)
a&&l&&(i.comment=l)
return c["default"].post("/api/v1/courses/".concat(t.id,"/blueprint_templates/default/migrations"),i)},checkMigration:function(e){return this.getMigrations(e).then(function(e){var t=l["a"].void
e.data[0]&&(t=e.data[0].workflow_state)
e.data=t
return e})},getMigration:function(e,t){var o=e.course
var a=t.blueprintType,l=void 0===a?"blueprint_templates":a,n=t.templateId,i=void 0===n?"default":n,r=t.changeId
return c["default"].get("/api/v1/courses/".concat(o.id,"/").concat(l,"/").concat(i,"/migrations/").concat(r))},getMigrationDetails:function(e,t){var o=e.course
var a=t.blueprintType,l=void 0===a?"blueprint_templates":a,n=t.templateId,i=void 0===n?"default":n,r=t.changeId
return c["default"].get("/api/v1/courses/".concat(o.id,"/").concat(l,"/").concat(i,"/migrations/").concat(r,"/details"))},getFullMigration:function(e,t){var o=this
var c=e.course
...
t["a"]=n},pREb:function(e,t,o){"use strict"
...
var n=["void","unknown"].concat(a,l)
var i={statesList:n,states:n.reduce(function(e,t){return Object.assign(e,Object(c["a"])({},t,t))},{})}
i.isEndState=function(e){return l.includes(e)}
i.isLoadingState=function(e){return a.includes(e)}
i.getLoadingValue=function(e){return a.indexOf(e)+1}
i.isSuccessful=function(e){return"completed"===e}
i.maxLoadingValue=a.length+1
...
Object(n["a"])(t,null,[{key:"setupRootNode",value:function(e,t,o){var c=document.createElement("span")
...
return o}Object(n["a"])(t,[{key:"render",value:function(){var e=this.state.mode.icon
...
var n=this.props.isLocked?j.t("Locked. Click to unlock."):j.t("Unlocked. Click to lock.")
o=Object(c["a"])(R.a,{tip:l,placement:"top",variant:"inverse",on:["hover","focus"]},void 0,Object(c["a"])(T.a,{variant:a,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked},void 0,Object(c["a"])(e,{}),Object(c["a"])(U.a,{},void 0,t),Object(c["a"])(M.a,{},void 0,n)))}else o=Object(c["a"])("span",{className:"bpc__lock-no__toggle"},void 0,Object(c["a"])("span",{className:"bpc__lock-no__toggle-icon"},void 0,Object(c["a"])(e,{})),Object(c["a"])(A.a,{size:"small"},void 0,t))
...
this.state={isLocked:false,itemLocks:[],isMasterContent:false,isChildContent:false,itemId:""}}Object(n["a"])(e,[{key:"init",value:function(e){if(!this.shouldInit())return
this.props=h(e)
this.setupState()
...
return(0,r.default)(this,(0,_.default)(t).apply(this,arguments))}(0,i.default)(t,[{key:"render",value:function(){return u.default.createElement(k.default,Object.assign({},this.props,{name:"IconBlueprint",viewBox:"0 0 1920 1920"}),d)}}])
...
//# sourceMappingURL=52-c-e62a80b9be.js.map